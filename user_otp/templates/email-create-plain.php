...
<?php p($_['requestor']) ?> requested the creation of an OTP token for your account for <?php p($_['title']) ?>[<?php 
...
?>] you have to provide a valid OTP token.
...
<?php
	...
	foreach ($_['config'] as $config):
		// skip config options without a value and with type image as they can't be displayed in plain mails
